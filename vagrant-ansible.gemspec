...
Gem::Specification.new do |s|
  ...
  s.version = "0.0.5.20130313220259"
  ...
  s.files = [".autotest", "CHANGELOG.md", "Manifest.txt", "README.md", "Rakefile", "Vagrantfile.sample", "lib/vagrant-ansible.rb", "lib/vagrant-ansible/provisioner.rb", "lib/vagrant_init.rb", ".gemtest"]
